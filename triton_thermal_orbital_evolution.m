...
%to right value
semi_major_axis(1)=100*neptune_radius; 
...
%
subplot(3,3,3);
plot(time(1:i-1)/(1e6*seconds_in_year),grain_size(1:i-1)*1e3,'k-','Linewidth',1.5)
xlabel('Time (Myr)')
ylabel('Ice Grainsize (mm)')
grid on
set(gca,'Fontsize',14)
%
subplot(3,3,4);
